...
*/    
	...
	//isaac
	//var topRow = document.createElement('i');
	//topRow.setAttribute("class","fa fa-caret-up");
	//$(topRow).css({
	//	"top": "0px",
	//	"position": "absolute",
	//	"left": "1px",
	...
	//var bopRow = document.createElement('i');
	//bopRow.setAttribute("class","fa fa-caret-down");
	//$(bopRow).css({
	//	"bottom": "1px",
	//	"position": "absolute",
	//	"left": "2px",
